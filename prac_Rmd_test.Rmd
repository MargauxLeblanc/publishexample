...
OSM <- st_read("C:/Users/Utilisateur/Documents/UCL_MSc_SGDS/T1_CASA0005_GISScience/week5/prac/prac5_r_proj/greater-london-latest-free.shp/gis_osm_pois_a_free_1.shp") %>%
  st_transform(., 27700) %>%
  #select hotels only
  filter(fclass == 'hotel')

Londonborough <- st_read("C:/Users/Utilisateur/Documents/UCL_MSc_SGDS/T1_CASA0005_GISScience/week5/prac/prac5_r_proj/statistical-gis-boundaries-london/ESRI/London_Borough_Excluding_MHW.shp") %>%   st_transform(., 27700)

Airbnb <- read_csv("C:/Users/Utilisateur/Documents/UCL_MSc_SGDS/T1_CASA0005_GISScience/week5/prac/prac5_r_proj/listings.csv") %>%
